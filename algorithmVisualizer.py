...
class AlgorithmVisualizer:
    ...
    def __init__(self):
        ...
        selectionSortButton = tk.Button(root, text="Selection Sort", width=50, height=5,
                                        command=self.visualize_selection_sort)
        insertionSortButton = tk.Button(root, text="Insertion Sort", width=50, height=5,
                                        command=self.visualize_insertion_sort)
